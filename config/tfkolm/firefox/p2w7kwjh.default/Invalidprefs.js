...
<<<<<<< HEAD
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1561032170);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1561022059);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1561320645);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1561021939);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1561090520);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1560539820);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1561320765);
=======
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1561118570);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1561108459);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1561129020);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1561108339);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1561112120);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1560539820);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1561107266);
>>>>>>> f4e4010d6d9ba7981330c0155587a87068fed759
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.cache.disk.capacity", 358400);
user_pref("browser.cache.disk.filesystem_reported", 1);
user_pref("browser.cache.disk.smart_size.first_run", false);
user_pref("browser.download.lastDir", "/home/aghiles/Aghiles/Redaction/0/res");
...
<<<<<<< HEAD
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1561320619300");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1561324219300");
=======
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1561128993600");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1561132593600");
>>>>>>> f4e4010d6d9ba7981330c0155587a87068fed759
...
<<<<<<< HEAD
user_pref("browser.shell.mostRecentDateSetAsDefault", "1561320617");
...
=======
user_pref("browser.shell.mostRecentDateSetAsDefault", "1561128991");
user_pref("browser.slowStartup.averageTime", 865);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1561118571);
...
user_pref("idle.lastDailyNotification", 1561105582);
...
user_pref("media.gmp-manager.lastCheck", 1561103026);
...
user_pref("places.database.lastMaintenance", 1560711466);
user_pref("places.history.expiration.transient_current_max_pages", 90395);
...
user_pref("services.blocklist.addons.checked", 1561108412);
user_pref("services.blocklist.clock_skew_seconds", 47);
user_pref("services.blocklist.gfx.checked", 1561108412);
user_pref("services.blocklist.last_etag", "\"1561074211915\"");
user_pref("services.blocklist.last_update_seconds", 1561108412);
user_pref("services.blocklist.onecrl.checked", 1561108412);
user_pref("services.blocklist.pinning.checked", 1561108412);
user_pref("services.blocklist.plugins.checked", 1561108412);
...
<<<<<<< HEAD
user_pref("toolkit.startup.last_success", 1561320614);
=======
user_pref("toolkit.startup.last_success", 1561128990);
>>>>>>> f4e4010d6d9ba7981330c0155587a87068fed759
