...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1560363857);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1560363977);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1560402153);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1560363737);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1560363617);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1560018768);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1560365344);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1560402126934");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1560405726934");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1560402125");
user_pref("browser.slowStartup.averageTime", 788);
...
user_pref("extensions.blocklist.lastModified", "Wed, 12 Jun 2019 11:45:40 GMT");
...
user_pref("extensions.getAddons.cache.lastUpdate", 1560363858);
...
user_pref("idle.lastDailyNotification", 1560243486);
...
user_pref("media.gmp-manager.lastCheck", 1560363713);
...
user_pref("places.history.expiration.transient_current_max_pages", 70919);
...
user_pref("services.blocklist.addons.checked", 1560363945);
user_pref("services.blocklist.clock_skew_seconds", 32);
user_pref("services.blocklist.gfx.checked", 1560363945);
user_pref("services.blocklist.last_etag", "\"1560339940028\"");
user_pref("services.blocklist.last_update_seconds", 1560363945);
user_pref("services.blocklist.onecrl.checked", 1560363945);
user_pref("services.blocklist.pinning.checked", 1560363945);
user_pref("services.blocklist.plugins.checked", 1560363945);
...
user_pref("toolkit.startup.last_success", 1560402123);
