...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1561047522);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1561021939);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1561038343);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1561046753994");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1561050353994");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1561043893");
...
user_pref("media.gmp-manager.lastCheck", 1561015947);
...
user_pref("places.history.expiration.transient_current_max_pages", 89622);
...
user_pref("toolkit.startup.last_success", 1561043892);
