...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1561989882);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1561991564);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1561972788);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1561991189511");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1561994789511");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1561992939");
user_pref("browser.slowStartup.averageTime", 737);
...
user_pref("places.history.expiration.transient_current_max_pages", 90506);
...
user_pref("toolkit.startup.last_success", 1561992938);
