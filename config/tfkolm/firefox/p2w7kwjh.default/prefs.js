...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1560631294);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1560631414);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1560706053);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1560631174);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1560695265);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1560539820);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1560631534);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1560718536428");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1560722136428");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1560718534");
user_pref("browser.slowStartup.averageTime", 847);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1560631295);
...
user_pref("idle.lastDailyNotification", 1560711466);
...
user_pref("media.gmp-manager.lastCheck", 1560631085);
...
user_pref("places.history.expiration.transient_current_max_pages", 85449);
...
user_pref("services.blocklist.addons.checked", 1560631411);
user_pref("services.blocklist.clock_skew_seconds", 3);
user_pref("services.blocklist.gfx.checked", 1560631411);
user_pref("services.blocklist.last_etag", "\"1560618350307\"");
user_pref("services.blocklist.last_update_seconds", 1560631411);
user_pref("services.blocklist.onecrl.checked", 1560631411);
user_pref("services.blocklist.pinning.checked", 1560631411);
user_pref("services.blocklist.plugins.checked", 1560631411);
...
user_pref("toolkit.startup.last_success", 1560718532);
