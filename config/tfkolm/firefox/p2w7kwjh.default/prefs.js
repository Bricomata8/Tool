...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1560258689);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1560258809);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1560262168);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1560258448);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1560260048);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1560018768);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1560258929);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1560262139071");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1560265739071");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1560264957");
user_pref("browser.slowStartup.averageTime", 821);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1560258690);
...
user_pref("media.gmp-manager.lastCheck", 1560264301);
...
user_pref("places.history.expiration.transient_current_max_pages", 66911);
...
user_pref("services.blocklist.addons.checked", 1560258794);
user_pref("services.blocklist.clock_skew_seconds", 15);
user_pref("services.blocklist.gfx.checked", 1560258794);
user_pref("services.blocklist.last_etag", "\"1560248603844\"");
user_pref("services.blocklist.last_update_seconds", 1560258794);
user_pref("services.blocklist.onecrl.checked", 1560258794);
user_pref("services.blocklist.pinning.checked", 1560258794);
user_pref("services.blocklist.plugins.checked", 1560258794);
...
user_pref("toolkit.startup.last_success", 1560264955);
