...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1562592842);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1562592962);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1562650383);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1562598926);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1562593082);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1562533736);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1562598121);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1562650360206");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1562653960206");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1562650357");
user_pref("browser.slowStartup.averageTime", 1103);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1562592843);
...
user_pref("idle.lastDailyNotification", 1562527062);
...
user_pref("media.gmp-manager.lastCheck", 1562592817);
...
user_pref("services.blocklist.addons.checked", 1562592923);
user_pref("services.blocklist.clock_skew_seconds", 39);
user_pref("services.blocklist.gfx.checked", 1562592923);
user_pref("services.blocklist.last_etag", "\"1562577903535\"");
user_pref("services.blocklist.last_update_seconds", 1562592923);
user_pref("services.blocklist.onecrl.checked", 1562592923);
user_pref("services.blocklist.pinning.checked", 1562592923);
user_pref("services.blocklist.plugins.checked", 1562592923);
...
user_pref("toolkit.startup.last_success", 1562650352);
