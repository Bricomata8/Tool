...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1561904231);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1561805728);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1561904111);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1561799443);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1561903658);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1561322397);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1561904351);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1561902383978");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1561905983978");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1561904588");
user_pref("browser.slowStartup.averageTime", 812);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1561904232);
...
user_pref("media.gmp-manager.lastCheck", 1561903661);
...
user_pref("places.history.expiration.transient_current_max_pages", 94224);
...
user_pref("services.blocklist.addons.checked", 1561805705);
user_pref("services.blocklist.clock_skew_seconds", 23);
user_pref("services.blocklist.gfx.checked", 1561805705);
user_pref("services.blocklist.last_etag", "\"1561710520557\"");
user_pref("services.blocklist.last_update_seconds", 1561805705);
user_pref("services.blocklist.onecrl.checked", 1561805705);
user_pref("services.blocklist.pinning.checked", 1561805705);
user_pref("services.blocklist.plugins.checked", 1561805705);
...
user_pref("toolkit.startup.last_success", 1561904586);
