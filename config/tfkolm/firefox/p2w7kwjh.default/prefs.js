...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1563099367);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1563088814);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1563154601);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1563097922);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1563132657);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1563138536);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1563088934);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1563154577480");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1563158177480");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1563154575");
user_pref("browser.slowStartup.averageTime", 1000);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1563099367);
...
user_pref("media.gmp-manager.lastCheck", 1563088747);
...
user_pref("places.history.expiration.transient_current_max_pages", 108261);
...
user_pref("services.blocklist.addons.checked", 1563088783);
user_pref("services.blocklist.clock_skew_seconds", 30);
user_pref("services.blocklist.gfx.checked", 1563088783);
user_pref("services.blocklist.last_etag", "\"1563062469645\"");
user_pref("services.blocklist.last_update_seconds", 1563088783);
user_pref("services.blocklist.onecrl.checked", 1563088783);
user_pref("services.blocklist.pinning.checked", 1563088783);
user_pref("services.blocklist.plugins.checked", 1563088783);
...
user_pref("toolkit.startup.last_success", 1563154571);
