...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1562164630);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1562078590);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1562163603);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1562165481);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1562149083);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1561928936);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1562164750);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1562163466724");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1562167066724");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1562165455");
user_pref("browser.slowStartup.averageTime", 1695);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1562164630);
...
user_pref("idle.lastDailyNotification", 1562156806);
...
user_pref("media.gmp-manager.lastCheck", 1562145529);
...
user_pref("places.history.expiration.transient_current_max_pages", 94956);
...
user_pref("toolkit.startup.last_success", 1562165450);
