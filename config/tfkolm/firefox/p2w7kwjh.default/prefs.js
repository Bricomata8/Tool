...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1561991285);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1561991623);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1562072396);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1561991564);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1562056541);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1561928936);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1561991483);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1562072253120");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1562075853120");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1562059636");
user_pref("browser.slowStartup.averageTime", 880);
...
user_pref("extensions.blocklist.lastModified", "Fri, 28 Jun 2019 08:28:40 GMT");
user_pref("extensions.blocklist.pingCountTotal", 29);
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 27);
user_pref("extensions.getAddons.cache.lastUpdate", 1561991286);
...
user_pref("places.history.expiration.transient_current_max_pages", 92212);
...
user_pref("services.blocklist.addons.checked", 1561991579);
user_pref("services.blocklist.clock_skew_seconds", 44);
user_pref("services.blocklist.gfx.checked", 1561991579);
user_pref("services.blocklist.last_etag", "\"1561988914045\"");
user_pref("services.blocklist.last_update_seconds", 1561991579);
user_pref("services.blocklist.onecrl.checked", 1561991579);
user_pref("services.blocklist.pinning.checked", 1561991579);
user_pref("services.blocklist.plugins.checked", 1561991579);
...
user_pref("toolkit.startup.last_success", 1562059632);
