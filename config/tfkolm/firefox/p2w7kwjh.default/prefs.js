...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1561706566);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1561706926);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1561734289);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1561706806);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1561727769);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1561322397);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1561706686);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1561726896200");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1561730496200");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1561734819");
user_pref("browser.slowStartup.averageTime", 924);
...
user_pref("extensions.blocklist.lastModified", "Thu, 27 Jun 2019 09:06:34 GMT");
...
user_pref("extensions.getAddons.cache.lastUpdate", 1561706567);
...
user_pref("idle.lastDailyNotification", 1561641664);
...
user_pref("media.gmp-manager.lastCheck", 1561706634);
...
user_pref("places.history.expiration.transient_current_max_pages", 92328);
...
user_pref("services.blocklist.addons.checked", 1561706883);
user_pref("services.blocklist.clock_skew_seconds", 42);
user_pref("services.blocklist.gfx.checked", 1561706883);
user_pref("services.blocklist.last_etag", "\"1561680025387\"");
user_pref("services.blocklist.last_update_seconds", 1561706883);
user_pref("services.blocklist.onecrl.checked", 1561706883);
user_pref("services.blocklist.pinning.checked", 1561706883);
user_pref("services.blocklist.plugins.checked", 1561706883);
...
user_pref("toolkit.startup.last_success", 1561734817);
