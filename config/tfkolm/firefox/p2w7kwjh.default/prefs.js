...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1559996642);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1559996762);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1559997665);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1559996522);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1559996402);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1557596174);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1559996929);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1560009837684");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1560013437684");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1560009836");
...
user_pref("devtools.telemetry.tools.opened.version", "{\"DEVTOOLS_SCREEN_RESOLUTION_ENUMERATED_PER_USER\":\"60.6.1\"}");
...
user_pref("extensions.getAddons.cache.lastUpdate", 1559996642);
...
user_pref("idle.lastDailyNotification", 1557952787);
...
user_pref("media.gmp-manager.lastCheck", 1559998132);
...
user_pref("places.database.lastMaintenance", 1557645385);
user_pref("places.history.expiration.transient_current_max_pages", 46782);
...
user_pref("services.blocklist.addons.checked", 1559996736);
user_pref("services.blocklist.clock_skew_seconds", 25);
user_pref("services.blocklist.gfx.checked", 1559996736);
user_pref("services.blocklist.last_etag", "\"1559867881089\"");
user_pref("services.blocklist.last_update_seconds", 1559996736);
user_pref("services.blocklist.onecrl.checked", 1559996736);
user_pref("services.blocklist.pinning.checked", 1559996736);
user_pref("services.blocklist.plugins.checked", 1559996736);
...
user_pref("storage.vacuum.last.places.sqlite", 1556983566);
user_pref("toolkit.startup.last_success", 1560009834);
