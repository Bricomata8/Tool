...
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1563001765);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1563001525);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1562884843);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1563001645);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1562533736);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1563001885);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1563003304409");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1563006904409");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1563001500");
...
user_pref("media.gmp-manager.lastCheck", 1563001837);
...
user_pref("places.history.expiration.transient_current_max_pages", 106687);
...
user_pref("services.blocklist.addons.checked", 1563001725);
user_pref("services.blocklist.clock_skew_seconds", 40);
user_pref("services.blocklist.gfx.checked", 1563001725);
user_pref("services.blocklist.last_etag", "\"1562976010319\"");
user_pref("services.blocklist.last_update_seconds", 1563001725);
user_pref("services.blocklist.onecrl.checked", 1563001725);
user_pref("services.blocklist.pinning.checked", 1563001725);
user_pref("services.blocklist.plugins.checked", 1563001725);
...
user_pref("toolkit.startup.last_success", 1563001493);
