...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1560172168);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1560172288);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1560195420);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1560172048);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1560172732);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1560018768);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1560172408);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1560196681546");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1560200281546");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1560195391");
...
user_pref("extensions.getAddons.cache.lastUpdate", 1560172170);
...
user_pref("idle.lastDailyNotification", 1560146782);
...
user_pref("media.gmp-manager.lastCheck", 1560174046);
...
user_pref("places.history.expiration.transient_current_max_pages", 60762);
...
user_pref("services.blocklist.addons.checked", 1560172233);
user_pref("services.blocklist.clock_skew_seconds", 55);
user_pref("services.blocklist.gfx.checked", 1560172233);
user_pref("services.blocklist.last_etag", "\"1560124875107\"");
user_pref("services.blocklist.last_update_seconds", 1560172233);
user_pref("services.blocklist.onecrl.checked", 1560172233);
user_pref("services.blocklist.pinning.checked", 1560172233);
user_pref("services.blocklist.plugins.checked", 1560172233);
...
user_pref("toolkit.startup.last_success", 1560195389);
