...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1560937946);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1560934826);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1560978416);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1560934706);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1560977961);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1560539820);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1560934466);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1560978390888");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1560981990888");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1560972452");
...
user_pref("extensions.getAddons.cache.lastUpdate", 1560937947);
...
user_pref("media.gmp-manager.lastCheck", 1560966320);
...
user_pref("places.history.expiration.transient_current_max_pages", 86660);
user_pref("security.sandbox.content.tempDirSuffix", "4f9f690b-f617-4623-97e5-13ec5d723065");
user_pref("services.blocklist.addons.checked", 1560934810);
user_pref("services.blocklist.clock_skew_seconds", 15);
user_pref("services.blocklist.gfx.checked", 1560934810);
user_pref("services.blocklist.last_etag", "\"1560878717273\"");
user_pref("services.blocklist.last_update_seconds", 1560934810);
user_pref("services.blocklist.onecrl.checked", 1560934810);
user_pref("services.blocklist.pinning.checked", 1560934810);
user_pref("services.blocklist.plugins.checked", 1560934810);
...
user_pref("toolkit.startup.last_success", 1560972450);
