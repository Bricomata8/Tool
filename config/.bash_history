...
git clone https://github.com/adidax/dht11
arduino
xx Paper.tex 
compile3 Paper.tex 
...
sudo apt install python-tensorflow
...
puyhon mapping.py 
python mapping.py 
sudp apt install ImportError: No module named osmosdr
sudp apt install osmosdr
sudo apt install osmosdr
bash pdr_comparison
bash pdr_comparison_experiment.sh 
bash pdr_comparison_experiment.sh noise
sudo pip install osmosdr
sudo pip3 install osmosdr
sudo pip install osmosdr
cd "/home/aghiles/Aghiles/Program/gw/lora"
./backup 
...
./backup 
arduino 
./arduino-cli-0.3.7-alpha.preview-linux64 
arduino-cli sketch new MyFirstSketch
cd "/home/aghiles/Arduino/MyFirstSketch"
...
arduino-cli core install mkr
arduino-cli board install uno
arduino-cli board install avr
arduino-cli board install mkr
arduino-cli board list
arduino-cli board install mkr
cd
arduino-cli compile --fqbn arduino:avr Arduino/MyFirstSketch
...
arduino-cli board listall arduino:samd:mkr1000
arduino-cli board listall arduino:samd
arduino-cli core listall arduino:samd:mkr1000
arduino-cli core listall arduino:avr
arduino-cli core install arduino:avr
arduino-cli core install littleBits:avr
...
arduino
arduino-cli upload -p /dev/ttyACM0 --fqbn arduino:avr:uno Arduino_LoRa_GPS.ino 
arduino-cli compile --fqbn arduino:avr:uno Arduino_LoRa_GPS.ino 
arduino-cli core update-index
arduino-cli core install SPI
arduino-cli core install SPI:spi
arduino-cli core install spi:spi
arduino-cli core install spi
arduino-cli lib install "SPI"
arduino-cli lib search spi
arduino-cli lib install "AD9850SPI"
arduino-cli compile --fqbn arduino:avr:uno Arduino_LoRa_GPS.ino 
arduino-cli lib search SX1272
arduino-cli compile --fqbn arduino:avr:uno Arduino_LoRa_GPS/Arduino_LoRa_GPS.ino 
ls
arduino-cli compile --fqbn arduino:avr:uno Arduino_LoRa_GPS/Arduino_LoRa_GPS.ino 
arduino
ls
...
cd Downloads/
ls
bash cmake-3.15.0-rc3-Linux-x86_64.sh 
cmake
version=3.14
build=5
mkdir ~/temp
...
cd ~ sudo pip install --upgrade pip sudo pip install mako numpy Cheetah3
sudo pip install --upgrade pip sudo pip install mako numpy Cheetah3
sudo pip install --upgrade pip
...
who
ps -A
cd ~/gnu/gnuradio/build$
cd ~/gnu/gnuradio/build
cmake ../
make
ls
cmake ../
sudo apt install liblog4cpp5
sudo apt install liblog4cpp
sudo apt install liblog4cpp5-dev
sudo apt install liblog4cpp-dev
sudo apt install log4cpp-dev
apt-get install liblog4cxx10 liblog4cxx10-doc
sudo apt-get install liblog4cxx10 liblog4cxx10-doc
sudo apt-get install liblog4cpp10 liblog4cpp10-doc
sudo apt-get install liblog4cpp10
sudo apt-get install liblog4cpp10-dev
sudo apt-get install liblog4cpp6-dev
...
ls
cmake ../
sudo apt install log4cpp-devel
sudo apt search log4cpp-devel
sudo apt search log4cpp5-devel
sudo apt install log4cpp5-devel
sudo apt install liblog4cpp5-devel
sudo apt search liblog4cpp5
sudo apt search log4cpp
sudo yum search all log4cpp
sudo cmake ../
sudo apt install  liblog4cpp5v5
sudo apt install  liblog4cpp5v5-dev
sudo apt install liblog4cpp5v5
sudo apt install liblog4cpp5-dev
...
sudo ldconfig
sudo ldconfig -v | grep liblog4cpp
sudo cmake ../
sudo apt remove --purge --auto-remove cmake
cmake
