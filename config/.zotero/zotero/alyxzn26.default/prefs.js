...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1557954952);
user_pref("app.update.lastUpdateTime.background-update-timer", 1557955192);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1557955072);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1557954832);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1557955312);
...
user_pref("extensions.zotero.sourceList.persist", "{\"L1\":true,\"P1\":false,\"C264\":true,\"C350\":true}");
