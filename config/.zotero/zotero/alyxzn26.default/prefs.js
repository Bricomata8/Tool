...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1556313085);
user_pref("app.update.lastUpdateTime.background-update-timer", 1556313325);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1556313205);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1556255145);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1556313446);
...
user_pref("extensions.zotero.fontSize", "1.15");
...
user_pref("extensions.zotero.translators.better-bibtex.preserveBibTeXVariables", true);
...
user_pref("idle.lastDailyNotification", 1556313301);
user_pref("intl.accept_languages", "en-US, en");
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.cookie.prefsMigrated", true);
user_pref("network.predictor.cleaned-up", true);
user_pref("places.database.lastMaintenance", 1556313301);
...
user_pref("storage.vacuum.last.places.sqlite", 1555492817);
