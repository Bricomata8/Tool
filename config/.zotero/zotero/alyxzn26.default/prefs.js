...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1559923189);
user_pref("app.update.lastUpdateTime.background-update-timer", 1559923429);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1559923309);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1559995041);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1559923549);
...
user_pref("idle.lastDailyNotification", 1559923469);
user_pref("intl.accept_languages", "en-US, en");
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.cookie.prefsMigrated", true);
user_pref("network.predictor.cleaned-up", true);
user_pref("places.database.lastMaintenance", 1559923469);
